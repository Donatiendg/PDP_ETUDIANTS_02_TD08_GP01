...
const char *wifi_ssid = "Donat";
const char *wifi_password = "123soleil";
...
const char *client_id = "TD08_GP01";
const char *topic1 = "TD08_GP01/temp";
const char *topic2 = "TD08_GP01/relhum";
...
void setup()
{
  ...
  {
    mqtt_client.publish(topic1, String(temp_measure).c_str());
    mqtt_client.publish(topic2, String(relative_humidity_measure).c_str());
  }
